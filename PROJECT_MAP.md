...
| Voice dictation — Requirement Agent's attachment (re-render/session-clear cleanup) | `scripts/requirement-agent.js` (raRenderCenter, raResetState) |
